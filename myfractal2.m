...
%         for n=1:size_mat(3) % number of epochs
%             for j=1:size_mat(1) % number of channels
%                 for i=1:(size_mat(2) - window_size) % number of windows
%                     fd_values_mat(j,i,n) = fd_values.chan(j).epoch(n).window(i);
%                 end
%             end
%         end
%         
%         for j=1:size_mat(1) % number of channels
%             for i=1:(size_mat(2) - window_size) % number of windows
%                 fd_mean_mat(j,i) = mean(fd_values_mat(j,i,:));
%             end
%         end
